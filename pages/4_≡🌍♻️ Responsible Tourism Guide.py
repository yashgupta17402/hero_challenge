...
def get_government_initiatives():
    ...
    return pd.DataFrame({
        ...
        'website': [
            ...
            'https://tourism.gov.in/prashad-scheme',
            'https://www.pib.gov.in/pressreleasepage.aspx?prid=1601784',
            'https://tourism.gov.in/sites/default/files/2020-08/adopt%20a%20Heritage%20Project%20Guidelines.pdf',
            'https://www.culturemap.in/nmcm.html',
            'https://itdc.co.in/ihtm_post/hunar-se-rozgar/',
            'https://www.pib.gov.in/PressReleasePage.aspx?PRID=2076957',
            'https://innovateindia.mygov.in/dekho-apna-desh/',
            'https://www.pib.gov.in/PressReleasePage.aspx?PRID=2111822',
            'https://en.wikipedia.org/wiki/Heritage_City_Development_and_Augmentation_Yojana'
        ]
    })
...
def get_impact_stories():
    ...
    return pd.DataFrame({
        ...
        'image_url': [
            'https://c9admin.cottage9.com/uploads/2494/The-Revival-Of-Lost-Art-Forms-In-India-Success-Stories-And-Challenges.jpg',
            'https://nexplore.org/blog/wp-content/uploads/2017/05/khonoma.png',
            'https://www.re-thinkingthefuture.com/wp-content/uploads/2024/01/10.-Havelis-of-Shekhawati-India-cover_900_584-1.jpg?w=999',
            'https://lakshmisharath.com/wp-content/uploads/2016/11/Picture4-1024x768.jpg',
            'https://the-shooting-star.com/wp-content/uploads/2017/09/img_7818.jpg?w=840'
        ]
    })
