...
# --- KPI Section ---
st.markdown('<div class="insight-box"> <h4>Key Performance Indicators</h4></div>', unsafe_allow_html=True)
...
st.markdown('<div class="insight-box"> <h4>Funding Allocation Analysis</h4></div>', unsafe_allow_html=True)
# st.markdown('<div class="dashboard-section">', unsafe_allow_html=True)
...
# Insights box
st.markdown('<div class="insight-box"> <h4>Key Insights on Funding Allocation</h4></div>', unsafe_allow_html=True)
...
# st.markdown('<div class="dashboard-section">', unsafe_allow_html=True)
st.markdown('<div class="insight-box"> <h4>Artisan Development & Cultural Preservation</h4></div>', unsafe_allow_html=True)
...
# Insights box
st.markdown('<div class="insight-box"> <h4>Key Insights on Artisan Development</h4></div>', unsafe_allow_html=True)
# st.markdown('<div class="insight-box">', unsafe_allow_html=True)
...
st.markdown('<div class="insight-box"> <h4>Tourism Impact & Economic Outcomes</h4></div>', unsafe_allow_html=True)
# st.markdown('<div class="dashboard-section">', unsafe_allow_html=True)
...
# Insights box
st.markdown('<div class="insight-box"> <h4>Key Insights on Tourism Impact </h4></div>', unsafe_allow_html=True)
...
# st.markdown('<div class="dashboard-section">', unsafe_allow_html=True)
st.markdown('<div class="insight-box"> <h4>Detailed Data Tables </h4></div>', unsafe_allow_html=True)
